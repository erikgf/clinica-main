...
curl_setopt($ch, CURLOPT_POSTFIELDS, ["p_fi"=>$hoy, "p_ff"=> $hoy, "p_nota"=>1]);
...
if (json_last_error()){
    $fileRespuesta = fopen("error_generar_firmar_resumenes_diarios_notas_".$numero_dia.".txt", "w") or die("Unable to open file!");
} else {
    $fileRespuesta = fopen("generar_firmar_resumenes_diarios_notas_".$numero_dia.".txt", "w") or die("Unable to open file!");
}
