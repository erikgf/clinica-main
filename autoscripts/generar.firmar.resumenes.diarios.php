...
if (json_last_error()){
    $fileRespuesta = fopen("error_generar_firmar_resumenes_diarios_".$numero_dia.".txt", "w") or die("Unable to open file!");
} else {
    $fileRespuesta = fopen("generar_firmar_resumenes_diarios_".$numero_dia.".txt", "w") or die("Unable to open file!");
}
