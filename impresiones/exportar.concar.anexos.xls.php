...
try {
  ...
  $data = $obj->obtenerDatosParaExportarAnexosCONCAR($fecha_inicio, $fecha_fin);
...
try {
    ...
    $fileTemplate = $directory.'main-template-anexos.xlsx';
    $newExportedFile = 'exportar-concar-anexos-'.str_replace("-","",$fecha_inicio).str_replace("-","",$fecha_fin).".xlsx";
