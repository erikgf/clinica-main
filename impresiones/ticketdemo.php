...
$cliente = utf8_decode($datos["cliente"]);
...
$pdf->Cell($ANCHO_COLS_DETALLE[2], $ALTO_LINEA + .5, "PRECIO", $BORDES,0,"C");
...
foreach ($detalle as $key => $value) {
  ...
  $pdf->CellFitScale($ANCHO_COLS_DETALLE[1], $ALTO_LINEA + .5,  utf8_decode($value["descripcion_item"]), $BORDES,0);
  $pdf->Cell($ANCHO_COLS_DETALLE[2], $ALTO_LINEA + .5, number_format($value["precio_venta_unitario"],2), $BORDES,0, "R");
...
var_dump($cadena_pdf417); exit;

$ruta_pdf417 = "pdf417".getHostByName(getHostName()).".png";
