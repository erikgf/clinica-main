    ...
    <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="fecha-cancelar" class="form-control" placeholder="Fecha">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td id="caja-realizante">PARTICULAR</td>
                            </tr>
                            <tr>
                                <td>Medico Ordena</td>
                                <td id="caja-ordenante">PARTICULAR</td>
                            </tr>
                            <tr>
                                <td>Emp. Convenio: </td>
                                <td></td>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="callout callout-warning bg-warning" style="width:200px;display:inline-block;" id="caja-result-cont">
                            <h5 id="caja-vuelot-o-credito">Saldo S./</h5> 
...
<script src="views/js/caja.js"></script>