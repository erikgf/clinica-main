...
if (!$objTemplate->validarPermisoRoles($objUsuario, [$objTemplate->ID_ROL_COORDINADOR_LABORATORIO, $objTemplate->ID_ROL_LABORATORIO, $objTemplate->ID_ROL_ADMINISTRADOR])){
