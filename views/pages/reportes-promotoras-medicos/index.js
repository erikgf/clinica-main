var MedicosPromotora = function() {
    ...
    this.setDOM = function(){    
        ...
        $txtFechaInicioMensual = $("#txt-fechainicio-mensualpromotoras");
        $txtFechaFinMensual = $("#txt-fechafin-mensualpromotoras");
        $btnImprimirEXCELMensual = $("#btn-imprimir-mensualpromotoras-excel");
    ...
    this.setEventos = function(){
        ...
        $btnImprimirEXCELMensual.on("click", function(e){
            e.preventDefault();
            window.open("../../../impresiones/medicos.promotoras.mensual.xls.php?fi="+$txtFechaInicioMensual.val()+"&ff="+$txtFechaFinMensual.val(),"_blank")
        });
    };
    ...
    Util.setFecha($txtFechaInicioMensual, hoy);
    Util.setFecha($txtFechaFinMensual, hoy);
    hoy = null;
...
$(document).ready(function(){
    objMedicosPromotora = new MedicosPromotora();
});
