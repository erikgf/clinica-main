        ...
        <td>
            <div class="input-group-prepend">
                ...
                <div class="dropdown-menu" style="">
                    ...
                    <!-- <a class="dropdown-item btn-cambiarcomprobante" data-id="{{id_atencion_medica}}"  href="#" title="Canjear Comprobante"><i class="fa fa-file-o"></i> CANJEAR COMPROBANTE</a> -->
                    {{/if_}}
                    <!-- <a class="dropdown-item btn-anularmovimiento" data-cliente="{{cliente}}" data-tipomovimiento="{{movimiento}}" data-id="{{id}}" href="#" title="Anular Movimiento"><i class="fa fa-trash"></i> ANULAR</a> -->
                </div>
            </div>
        </td>
