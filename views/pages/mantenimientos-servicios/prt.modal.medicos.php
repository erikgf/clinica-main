                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control uppercase" id="txt-medico-esinformante">
                                        <option value="0">INFORMANTE</option>
                                        <option selected value="1">NO INFORMANTE</option>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control uppercase" id="txt-medico-esrealizante">
                                        <option value="0">REALIZANTE</option>
                                        <option selected value="1">NO REALIZANTE</option>
                                    </select>
                                </div>
                            </div>
                        </div>
