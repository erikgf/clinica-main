                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Número de Documento <span id="blk-spinner" style="display:none;" class="fa fa-spin fa-spinner"></span></label>
                                    <input type="text" name="txt-numerodocumento" class="form-control uppercase" id="txt-numerodocumento" maxlength="8"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <input type="tel" class="form-control uppercase" maxlength="6" id="txt-telefonofijo">
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                                <label>Celular 1</label>
                                <input type="tel" class="form-control uppercase" maxlength="9" id="txt-celular1">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                <label>Celular 2</label>
                                <input type="tel" class="form-control uppercase" maxlength="9" id="txt-celular2">
                                </div>
                            </div>
                        </div>
