    ...
    <div class="card-body">
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                            <input id="txt-horaatencion" type="text" class="form-control datetimepicker-input" data-target="#datetimepicker1"/>
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="datetimepicker2" data-target-input="nearest">
                            <input id="txt-fechaatencion" type="text" class="form-control datetimepicker-input" data-target="#datetimepicker2"/>
            ...
            <div class="row">
                ...
                <div class="col-sm-4" style="padding-left:8px">
                    ...
                    <label for="">Agregar Servicios</label>
                        <select id="txt-servicios" class="select-style">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div id="blk-servicios" style="min-height:10vh;box-shadow: 2px 2px 5px 1px rgba(179,179,179,1);background-color:#f7faff">
                        </div>
                    </div>
                </div>
            </div>
            
            <div class="col-sm-12 subtotal-cont hide" id="txt-subtotal">
                <div class="col-sm-2">
            ...
            <div class="row">
                <div class="offset-9 col-sm-3">
                    <button type="button" class="btn btn-block btn-success btn-lg" id="btn-continuar" disabled>REALIZAR PAGO</button>
                </div>
            </div>
            <!---------------------------------- Modal ------------------------------>
