        ...
        <td>
            <div class="input-group-prepend">
                ...
                <div class="dropdown-menu p-0">
                    <button class="dropdown-item bg-success btn-cambiarclave" data-id="{{id_medico}}"  data-nombres="{{nombres}}"  title="Cambiar Clave"><i class="fa fa-lock"></i> Cambiar Clave</button>
