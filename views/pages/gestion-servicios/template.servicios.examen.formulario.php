    ...
    <tr data-id="{{id_lab_examen}}"> 
        <td class="input-group-sm">
            <select data-pos="0" class="form-control txt-nivel">
                {{#if_ eliminar '==' 1}}
                <option {{#if_ nivel '==' '99'}}selected{{/if_}} value="99">0</option>
                {{/if_}}
                <option {{#if_ nivel '==' '0'}}selected{{/if_}} value="0">1</option>
                <option {{#if_ nivel '==' '1'}}selected{{/if_}} value="1">2</option>
                <option {{#if_ nivel '==' '2'}}selected{{/if_}} value="2">3</option>
            </select>
        </td>
        <td class="input-group-sm">
